...
export const getGroups = (data) => {
	return axios.request({
		url: 'manage/adminUser/getGroups',
		method: 'post',
...
export const getRoles = (data) => {
	return axios.request({
		url: 'manage/adminUser/getAllRoles',
		method: 'post',
...
export const getParents = (data) => {
	return axios.request({
		url: 'manage/adminUser/getValidUsers',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getStore = (data) => {
	return axios.request({
		url: 'manage/adminUser/getAllManufacturer',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const addDeps = (data) => {
	return axios.request({
		url: 'manage/manufacturer/saveManufacturer',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getAllResource = (data) => {
	return axios.request({
		url: 'manage/userRole/getAllResource',
		method: 'post',
...
export const addCustomer = (data) => {
	return axios.request({
		url: 'manage/client/addClientInfo',
		method: 'post',
...
export const updateCustomer = (data) => {
	return axios.request({
		url: 'manage/client/updateClientInfo',
		method: 'post',
...
export const searchCustomer = (data) => {
	return axios.request({
		url: 'manage/client/queryClientInfoList',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const delCustomer = (data) => {
	return axios.delete('manage/client/deleteClientInfo', {
		params: data
	}).then(result => {
...
export const getProject = (data) => {
	return axios.get('manage/cntract/project/selectProject', {
		params: data
	}).then(result => {
		console.log('result',result)
		return getAjax(result);
...
export const addGroups = (data) => {
	return axios.request({
		url: 'manage/adminusergroup/saveGroup',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const delGroups = (data) => {
	return axios.request({
		url: 'manage/adminusergroup/delGroup',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getGroupsAll = (data) => {
	return axios.request({
		url: 'manage/adminusergroup/page',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getUserAll = (data) => {
	return axios.request({
		url: 'manage/adminusergroup/getValidUsers',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getSysMenus = (data) => {
	return axios.request({
		url: 'manage/permission/getSysMenus',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getNewSysMenus = (data) => {
	return axios.request({
		url: 'manage/permission/getNavigateList',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getHref = (data) => {
	return axios.request({
		url: 'manage/permission/getLoginUrl',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const addDepartment = (data) => {
	return axios.request({
		url: 'manage/department/saveDepartment',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getTissueList = (data) => {
	return axios.request({
		url: 'defense/manage/tissue/findTissueList',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const addTissue = (data) => {
	return axios.request({
		url: 'defense/manage/tissue/addTissue',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const editTissue = (data) => {
	return axios.request({
		url: 'defense/manage/tissue/updateTissue',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const delTissue = (data) => {
	return axios.delete('defense/manage/tissue/deleteTissue', {
		params: data
	}).then(result => {
		console.log('result',result)
		return getAjax(result);
...
export const getValidUsers = (data) => {
	return axios.request({
		url: 'defense/manage/tissue/getValidUsers',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getAllPlayer = (data) => {
	return axios.request({
		url: 'defense/manage/player/page',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const addPlayer = (data) => {
	return axios.request({
		url: 'defense/manage/player/savePlayer',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const delPlayer = (data) => {
	return axios.request({
		url: 'defense/manage/player/delById',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const disPlayer = (data) => {
	return axios.request({
		url: 'defense/manage/player/prohibit',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getAllTissuse = (data) => {
	return axios.request({
		url: 'defense/manage/player/getAllTissuse',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getAllUsers = (data) => {
	return axios.request({
		url: 'defense/manage/player/getValidUsers',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getReferee = (data) => {
	return axios.request({
		url: 'defense/manage/referee/getValidUsers',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getAllReferee = (data) => {
	return axios.request({
		url: 'defense/manage/referee/page',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const addReferee = (data) => {
	return axios.request({
		url: 'defense/manage/referee/saveReferee',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const delReferee = (data) => {
	return axios.request({
		url: 'defense/manage/referee/delById',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const disReferee = (data) => {
	return axios.request({
		url: 'defense/manage/referee/prohibit',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getStoreList = (data) => {
	return axios.request({
		url: 'defense/manage/gameEvent/getManfacturerList',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
...
export const getStoreUsers = (data) => {
	return axios.request({
		url: 'defense/manage/gameEvent/getAllManfacturerUser',
		method: 'post',
		params: data.queryData,
		data: data.paramsData,
	}).then(result => {
